...
#ifndef __exlcm_angle_t_hpp__
#define __exlcm_angle_t_hpp__
...
int angle_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int angle_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int angle_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t angle_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* angle_t::getTypeName()
{
    return "angle_t";
}

int angle_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int angle_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int angle_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t angle_t::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x1052689d368f1671LL;
