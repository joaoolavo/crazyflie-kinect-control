...
#ifndef __crazyflie_t_crazyflie_pos_t_hpp__
#define __crazyflie_t_crazyflie_pos_t_hpp__


namespace crazyflie_t
{

class crazyflie_pos_t
{
    public:
        int64_t    timestamp;
...
int crazyflie_pos_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int crazyflie_pos_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int crazyflie_pos_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t crazyflie_pos_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* crazyflie_pos_t::getTypeName()
{
    return "crazyflie_pos_t";
}

int crazyflie_pos_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int crazyflie_pos_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int crazyflie_pos_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t crazyflie_pos_t::_computeHash(const __lcm_hash_ptr *)
{
